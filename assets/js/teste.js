...
const keyLimpar = document.querySelector('.key-clean');
const keyCalcular = document.querySelector('.key-calcular');
...
document.addEventListener('keypress', function(e) {
    tds.forEach((tecla) => {
        let td = tecla.getAttribute('name');
        if (e.key === td) {
            verifica(tecla);
        }
    })
